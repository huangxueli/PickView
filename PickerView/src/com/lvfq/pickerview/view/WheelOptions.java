...
//		// 添加联动监听
    ...
    public void setLablePadingRight(float padingRight){
    	wv_option1.setLablePadingRight(padingRight);
    	wv_option2.setLablePadingRight(padingRight);
    	wv_option3.setLablePadingRight(padingRight);
    }
    
    public void setLabelYOffset(float yoffset){
    	wv_option1.setLableYOffset(yoffset);
    	wv_option2.setLableYOffset(yoffset);
    	wv_option3.setLableYOffset(yoffset);
    }
    
    public void setContentXOffset(float offset){
    	wv_option1.setContentXOffset(0-offset);
    	wv_option2.setContentXOffset(0-offset);
    	wv_option3.setContentXOffset(0-offset);
    }
    
    public void setCenterContentYOffset(float offset){
    	wv_option1.setCenterContentYOffset(offset);
    	wv_option2.setCenterContentYOffset(offset);
    	wv_option3.setCenterContentYOffset(offset);
    }
    ...
    public void setCurrentItems(int option1, int option2, int option3) {
        if (linkage) {  // 此处的linkage为true会造成布局错乱
	...
	private void itemSelected(int opt1Select, int opt2Select, int opt3Select) {
    	wv_option1.setAdapter(new ArrayWheelAdapter(mOptions1Items, ArrayWheelAdapter.DEFAULT_LENGTH));
